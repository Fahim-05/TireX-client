...
const Blog = () => {
    return (
        <div className='w-7/12 mx-auto grid gap-4'>
            <div tabIndex={0} className="collapse collapse-plus border border-base-300 rounded-box bg-orange-200">
            ...
            <div tabIndex={0} className="collapse collapse-plus border border-base-300 bg-orange-200 rounded-box">
                <div className="collapse-title text-sm font-medium">
